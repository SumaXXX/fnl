...
let scrollLi = document.querySelector(".scroll-menu__li");
scrollLi.addEventListener("click", () => {
  scrollLi.classList.add("");
});
...
links.forEach(function (link) {
  link.addEventListener("click", function () {
    // Удаляем класс 'active' у всех других ссылок
...
document.querySelector('.read-more-text').addEventListener("click", function () {
  document.querySelectorAll(".main-info__description").forEach(el => el.style.setProperty("display","none"))
  document.querySelector('.main-info__full-description').style.setProperty("display","block");
